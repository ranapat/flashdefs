package __AS3__.vec
{
    ...
    final dynamic class Vector$uint extends Object
    {
        ...
        function Vector$uint(param1:uint = 0, param2:Boolean = false)
        {
            return;
        }// end function

        private function newThisType() : Vector$uint;
        ...
        function concat(... args) : Vector$uint
        {
            return this._concat(args);
        }// end function

        function filter(param1:Function, param2:Object = null) : Vector$uint
        {
        ...
        function slice(param1:Number = 0, param2:Number = 2147483647) : Vector$uint
        {
            return this._slice(param1, param2);
        }// end function

        function sort(param1) : Vector$uint
        {
            var _loc_2:* = [param1];
            _sort(this, _loc_2);
            return this;
        ...
        function splice(param1:Number, param2:Number, ... args) : Vector$uint
        {
            return this._splice(param1, param2, args);
        }// end function

        function indexOf(param1:uint, param2:Number = 0) : Number
        {
        ...
        function lastIndexOf(param1:uint, param2:Number = 2147483647) : Number
        {
            var _loc_3:* = this.clamp(param2, this.length);
        ...
        private static function castToThisType(param1) : Vector$uint
        {
            return param1;
        }// end function
